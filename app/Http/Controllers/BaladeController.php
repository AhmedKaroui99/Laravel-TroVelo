...
class BaladeController extends Controller
{
    ...
    public function AllBalade(){
      ...
      public function AllBalade2(){
        $balades=Balade::all();
        return view('Balade.BackOffice.AllBalade2')->with('balades',$balades);
     }
     ...
     */
     ...
     public function AddBalade(Request $request){
        ...
        $request->validate([
            'titleBalade' => 'required',
             'descriptionBalade' => 'required',
             'dateBalade' => 'required',
             'capaciteBalade' => 'required',
             'imageDescBalade' => 'required',
             'MoyensBalade' => 'required',
