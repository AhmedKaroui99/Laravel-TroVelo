...
class ParticipantController extends Controller
{
     ...
     public function createParticipant()
   {
    ...
    public function AddParticipant(Request $request)
    {
        ...
        $request->validate([
            'balade_id' => 'required',
             'NomParticipant' => 'required',
             'PrenomParticipant' => 'required',
             'MailParticipant' => 'required',
             'EtatPhysique' => 'required',
             'imageParticipant' => 'required',
             'numParticipant' => 'required',
             'AgeParticipant' => 'required',
         ]);
    ...
    public function export_participant_pdf()
    {
        $participants=Participant::get();
        $pdf = PDF::loadview('pdfparticipant.participants',[
