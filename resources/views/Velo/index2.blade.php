...
<!-- header section start -->
      ...
      <div class="cycle_section layout_padding">
        <h1 class="cycle_taital">Nos Velos</h1>
            <p class="cycle_text">Choisissez parmi une large gamme de vélos entiérement à votre disposition</p>
          @if(count($data) > 0)	
                 @foreach($data as $row)
            <div class="container">
            ...
            <div class="cycle_section_2 layout_padding">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <h2>{{ $row->velo_name }}</h2>
                     <p class="lorem_text">Spécifications : {{ $row->velo_spefication }}</p>
                     <p class="lorem_text">Disponibilité : {{ $row->velo_availability }}</p>
