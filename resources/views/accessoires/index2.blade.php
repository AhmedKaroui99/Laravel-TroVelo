...
<!-- header section start -->
      ...
      <div class="news_section layout_padding">
         <div class="container">
            <h1 class="news_taital">Nos Accessoires</h1>
            <p class="news_text">Choisissez dans une large variété d'accessoires</p>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="box_main_1">
                        <div class="zoomout frame"><img src="/coverAccessoire/{{ $accessoire->image }}"></div>
                        <div class="padding_15">
                           <h2 class="speed_text">{{$accessoire->nomAccessoire}}</h2>
                           <div class="post_text">{{$accessoire->prix}} dt<span style="float: right;"></span></div>
                        </div>
                     </div>
                  </div>
                   @endforeach
