        ...
        <h1 class="cycle_taital">Our cycle</h1>
            ...
            @foreach ($balades as $balades)
              <div class="cycle_section_3 layout_padding">
               <div class="row">
                  <div class="col-md-6">
                     <h1 class="cycles_text">{{ $balades->titleBalade }}</h1>
                     <p class="lorem_text">{{ $balades->descriptionBalade }}</p>
                     <p class="lorem_text">Date :{{ $balades->dateBalade }}</p>
                     <p class="lorem_text">Capacité : {{ $balades->capaciteBalade }}</p>
                     <p class="lorem_text">Moyens Balade : {{ $balades->MoyensBalade }}</p>
                     <p class="lorem_text">Destination : {{ $balades->Destination }}</p>
                  ...
                  <div class="col-md-6">
                     <div class="box_main_3">
                        ...
                        <div class="image_2"><img src="/coverBalade/{{ $balades->imageDescBalade }}"></div>
                     </div>
                  </div>
               </div>
            </div>
