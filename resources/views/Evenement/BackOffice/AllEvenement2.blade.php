...
<!-- header section start -->
      ...
      <form class="form-inline my-2 my-lg-0" method="get" action="{{url('/FrontOffice/EvenementsSearch')}}">
    <div class="d-flex">
        <input class="form-control mr-sm-2" name="query" type="search" placeholder="Search For event" aria-label="Search">
      ...
      <div class="cycle_section layout_padding">
        <h1 class="cycle_taital">Nos Evenements</h1>
            ...
            @foreach ($evenements as $evenement)
              <div class="cycle_section_3 layout_padding">
               <div class="row">
                  <div class="col-md-6">
                     <h1 class="cycles_text">{{ $evenement->title }}</h1>
                     <p class="lorem_text">{{ $evenement->description }}</p>
                     <p class="lorem_text">Date : {{ $evenement->date  }}</p>
                     <p class="lorem_text">Capacité : {{ $evenement->capacite }}</p>



                     <div class="btn_main">
                        <div class="buy_bt"><a href="/FrontOffice/ReservationEvenement/{{ $evenement->id }}">Réserver</a></div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="box_main_3">
                        <h6 class="number_text_2">02</h6>
                        <div class="image_2"><img src="/cover/{{ $evenement->image }}"></div>
                     </div>
                  </div>
               </div>
            </div>
