...
<!-- header section start -->
      ...
      <div class="news_section layout_padding">
         <div class="container">
            <h1 class="news_taital">Nos Posts</h1>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="box_main_1">
                        <div class="zoomout frame"><img src="/cover/{{ $post->img }}"></div>
                        <div class="padding_15">
                           <h2 class="speed_text">{{ $post->name }}</h2>

                           <div class="post_text">          <td>{{$post->CategoryA->name}}</td><span style="float: right;"></span></div>

                           <div class="post_text">{{ $post->content }}<span style="float: right;"></span></div>
                        </div>
                     </div>
                  </div>
                  @endforeach
