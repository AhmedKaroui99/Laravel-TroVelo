                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="idVelo" name="idVelo">
                                ...
                                @foreach($velos as $velo)
                                    <option value="{{$velo->id}}">{{$velo->velo_name}}</option>
                                    @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="idTrotinette">Trotinette</label>
                            <select class="form-control" id="idTrotinette" name="idTrotinette">
                                <option value="0">Select Trotinette</option>
                                @foreach($trotinettes as $trotinette)
                                    <option value="{{$trotinette->id}}">{{$trotinette->trotinette_name}}</option>
                                    @endforeach
